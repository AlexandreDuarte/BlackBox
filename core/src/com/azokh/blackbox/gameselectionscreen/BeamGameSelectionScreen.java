...
public class BeamGameSelectionScreen implements Element {
    ...
    public BeamGameSelectionScreen(int title_delta, int title_height, Color laserColor1, Color laserColor2) {
        beamElement2 = new BeamElement(Gdx.graphics.getWidth(), 2.0f, Gdx.graphics.getHeight()/3-title_height-65, laserColor2, false, false);
        beamElement1 = new BeamElement(Gdx.graphics.getWidth(), 2.0f, 2*Gdx.graphics.getHeight()/3-title_height+65, laserColor1, false, true);
